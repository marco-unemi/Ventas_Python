...
class RegularClient(Client):
    def __init__(self, first_name="Cliente", last_name="Final", dni="9999999999", card=False, tipo_cliente="Cliente REGULAR"):
    ...
    def getJson(self):
        # Método para imprimir los detalles del cliente minorista en la consola
        return {"dni": self.dni, "nombre": self.first_name, "apellido": self.last_name, "valor_descuento": self.discount, "card": self.card, "tipo_cliente": self.tipo_cliente}


class VipClient(Client):
    def __init__(self, first_name="Consumidor", last_name="Final", dni="9999999999", tipo_cliente="Cliente VIP"):
    ...
    def getJson(self):
        # Método para imprimir los detalles del cliente VIP en la consola
        return {"dni": self.dni, "nombre": self.first_name, "apellido": self.last_name, "valor_credito": self.limit, "tipo_cliente": self.tipo_cliente}
